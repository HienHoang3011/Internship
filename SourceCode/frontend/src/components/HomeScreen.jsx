  ...
  return (
    <div className="home-screen">
      ...
      <header className="navbar">
        <img src={logoWeb} alt="MindCareAI Logo" className="logo-img" onClick={() => setCurrentView('home')} style={{ cursor: 'pointer', height: '100px', mixBlendMode: 'multiply' }} />
      ...
      <section className="testimonials-section">
        <div className="testimonials-container">
          ...
          <div className="testimonials-grid">
            {[
              { name: 'Mai Tiến Đạt', text: 'Ứng dụng thực sự tuyệt vời! MindCareAI đã giúp tôi vượt qua những giai đoạn áp lực nhất trong công việc. Khả năng lắng nghe và tư vấn không khác gì một chuyên gia tâm lý thực thụ.' },
              ...
              { name: 'Nguyễn Mạnh Hùng', text: 'Chưa từng thấy một AI nào có khả năng đồng cảm tốt đến vậy. MindCareAI giúp tôi nhìn nhận lại bản thân và cải thiện sức khỏe tinh thần đáng kể. Rất đánh giá cao đội ngũ phát triển!' },
              ...
              <div key={index} className="testimonial-card">
                ...
                <div className="testimonial-author">
                  ...
                  <div className="author-info">
                    ...
                    <span className="author-role">Người dùng MindCareAI</span>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section id="faq" className="faq-section">
        <div className="faq-container">
          ...
          <div className="faq-list">
            ...
            <div className="faq-item">
              <h3>MindCareAI có tính phí không?</h3>
              <p>Hiện tại, MindCareAI cung cấp các tính năng hỗ trợ cơ bản hoàn toàn miễn phí. Đội ngũ mong muốn mang đến công cụ chăm sóc sức khỏe tinh thần dễ tiếp cận cho tất cả mọi người.</p>
            </div>
            <div className="faq-item">
              <h3>Tôi có thể dùng MindCareAI trên điện thoại không?</h3>
              <p>Có, giao diện của MindCareAI được thiết kế tương thích và tối ưu hóa hoàn toàn cho các thiết bị di động, giúp bạn dễ dàng tâm sự mọi lúc mọi nơi.</p>
            </div>
          </div>
        </div>
      </section>
